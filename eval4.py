...
def main():
    ...
    parser.add_argument("--recv2", "-r2", default="./outputs/predict_noise/k=-0.5", help="Directory for 'received' images (comparison target 2)")
    parser.add_argument("--recv3", "-r3", default="./outputs/predict_noise/k=1.0", help="Directory for 'received' images (comparison target 3, optional)")
    # --- ⭐ 変更点: recv4 の引数を追加 ---
    parser.add_argument("--recv4", "-r4", default="./outputs/predict_noise/k=0.5", help="Directory for 'received' images (comparison target 4, optional)")
